  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Image
          source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXkKib_nrcYWXrszEe5zuxLe7f3aPFBpsjSw&s' }}
          style={styles.icon}
        />
        <Text style={styles.headerText}>Plumber At Your Service</Text>
      </View>
