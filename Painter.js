  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Image
          source={{ uri: 'https://e7.pngegg.com/pngimages/748/132/png-clipart-cartoon-painter-hand-tool-cartoon-worker-thumbnail.png' }}
          style={styles.icon}
        />
        <Text style={styles.headerText}>Painters At Your Service</Text>
      </View>
